...
The Ghost Mode: Change the background to dark blue and the particles to white with a lower opacity (0.02).

Turbulence: In the angle calculation, multiply the result by 20. What happens to the flow?
...
Art: Increase the ctx.lineWidth in the advanced_flow.html.

📺 Watch the Tutorial

[\[Link to your YouTube Video\]](https://youtu.be/cSJq9anv8gI)
